...
data2_1 = sobol_seq.i4_sobol_generate(2,100)
data2_2 = data2_1[:, 0]
data2_3 = data2_1[:, 1]
ax2.scatter(data2_2, data2_3, s=1)
...
data = np.random.randn(2, 500)
data4_1 = sobol_seq.i4_sobol_generate(2,500)
data4_2 = data4_1[:, 0]
data4_3 = data4_1[:, 1]
ax4.scatter(data4_2, data4_3, s=1)
ax4.set_yticklabels([])
ax4.set_xticklabels([])
...
data = np.random.randn(2, 1000)
data6_1 = sobol_seq.i4_sobol_generate(2,1000)
data6_2 = data6_1[:, 0]
data6_3 = data6_1[:, 1]
ax6.scatter(data6_2, data6_3, s=1)
ax6.set_yticklabels([])
ax6.set_xticklabels([])
...
data = np.random.randn(2, 2000)
data8_1 = sobol_seq.i4_sobol_generate(2,2000)
data8_2 = data8_1[:, 0]
data8_3 = data8_1[:, 1]
ax8.scatter(data8_2, data8_3, s=1)
ax8.set_yticklabels([])
ax8.set_xticklabels([])
...
np.random.seed(154143)
data = np.random.randn(2, 5000)
data10_1 = sobol_seq.i4_sobol_generate(2,5000)
data10_2 = data10_1[:, 0]
data10_3 = data10_1[:, 1]
ax10.scatter(data10_2, data10_3, s=1)
